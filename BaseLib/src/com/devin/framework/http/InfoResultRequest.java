...
public class InfoResultRequest extends Request<InfoResult> implements Listener<InfoResult>
{
    ...
    public InfoResultRequest(final int requestId, String url, int method, String body, ResponseParserListener parseListener, final ITransfer logic)
    {
        this(requestId, url, method, body, null, parseListener, logic);
    }
    
    public InfoResultRequest(final int requestId, String url, int method, Map<String, String> params, ResponseParserListener parseListener, final ITransfer logic)
    {
        this(requestId, url, method, null, params, parseListener, logic);
    }
    
    public InfoResultRequest(final int requestId, String url, ResponseParserListener parseListener, final ITransfer logic)
    {
        this(requestId, url, Method.GET, null, null, parseListener, logic);
    }
    
    public InfoResultRequest(final int requestId, String url, String body, ResponseParserListener parseListener, final ITransfer logic)
    {
        this(requestId, url, Method.POST, body, null, parseListener, logic);
    }
    
    public InfoResultRequest(final int requestId, String url, Map<String, String> params, ResponseParserListener parseListener, final ITransfer logic)
    {
        this(requestId, url, Method.POST, null, params, parseListener, logic);
    }
    
    public InfoResultRequest(final int requestId, String url, int method, String body, Map<String, String> params, ResponseParserListener parseListener, final ITransfer logic)
    {
        super(method, url, new ErrorListener()
        {
            ...
            {
            	LoggerFactory.getLogger(InfoResultRequest.class).warn(error.getLocalizedMessage());
