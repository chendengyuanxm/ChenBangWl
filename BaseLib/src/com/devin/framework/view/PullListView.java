package com.devin.framework.view;
...
public class PullListView extends ListView implements OnScrollListener {
	...
	/**已加载全部*/
	private final static int ENDINT_LOAD_ALL = 4;
	...
	public PullListView(Context pContext, AttributeSet pAttrs) {
		super(pContext, pAttrs);
		init(pContext);
	}

	public PullListView(Context pContext) {
		super(pContext);
		init(pContext);
	}

	public PullListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {
	...
	private void addHeadView() {
		mHeadView = (LinearLayout) mInflater.inflate(R.layout.listview_head,
				null);
...
//		if(mLastItemIndex == mCount && mEndLoadTipsTextView != null) {
//			mEndLoadTipsTextView
//				.setText(R.string.p2refresh_head_load_more);
//		}
	}
	...
	private void changeEndViewByState() {
		if (mCanLoadMore) {
			...
			case ENDINT_LOAD_ALL:	//已加载全部
				mEndLoadTipsTextView.setText(R.string.p2refresh_load_all);
				mEndLoadTipsTextView.setVisibility(View.VISIBLE);
				mEndLoadProgressBar.setVisibility(View.GONE);
...
//				 }
	...
	private void changeHeaderViewByState() {
		...
		case DONE:
			...
			mProgressBar.setVisibility(View.GONE);
			mArrowImageView.clearAnimation();
			mArrowImageView.setImageResource(R.drawable.pull_to_refresh_arrow);
			// 下拉刷新
			mTipsTextView.setText(R.string.p2refresh_pull_to_refresh);
			mLastUpdatedTextView.setVisibility(View.VISIBLE);
	 ...
	 * 加载更多完成
	 * 
	 * @param hasLoadAll 标志是否已加载全部
	 * @date 2013-11-11 下午10:21:38
	 * @change JohnWatson
	 * @version 1.0
	 */
	public void onLoadMoreComplete(boolean hasLoadAll) {
		if(hasLoadAll) {
			mEndState = ENDINT_LOAD_ALL;
