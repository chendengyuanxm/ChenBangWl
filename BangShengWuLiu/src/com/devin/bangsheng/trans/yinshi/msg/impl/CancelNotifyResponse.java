...
public class CancelNotifyResponse extends AbstractYsResponse{
	...
	public String toString() {
		return "ConsumeNotifyResponse [txnId=" + txnId + ", spId=" + spId
				+ ", orderNo=" + orderNo + ", employNo=" + employNo
				+ ", payWay=" + payWay + ", transType=" + transType
				+ ", wlTrace=" + wlTrace + ", signFlag=" + signFlag
				+ ", signer=" + signer + ", respTime=" + respTime
				+ ", respCode=" + respCode + ", amount=" + amount + ", pan="
				+ pan + ", mid=" + mid + ", tid=" + tid + ", rrn=" + rrn
				+ ", systrace=" + systrace + ", batchNo=" + batchNo
				+ ", posTrace=" + posTrace + "]";
	}
}
